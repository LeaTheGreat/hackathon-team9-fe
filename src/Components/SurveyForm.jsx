  ...
  return (
    <div className="wrapper">
      ...
      >
        ...
        <fieldset id="q3">
          <h5>
            Does your child point to indicate that s/he wants something? (e.g.
        ...
        <fieldset id="q4">
          <h5>
            Does your child point to share interest with you? (e.g. pointing at
        ...
        <fieldset id="q7">
          <h5>
            ...
            child show signs of wanting to comfort them? (e.g. stroking hair,
            hugging them)
          </h5>
          <div className="answer-wrapper">
            <input
